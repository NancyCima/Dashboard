...
const percepcionesColumns = [
  { id: 'tipo_operacion', label: 'Retenc/Percep', width: 130 },
  { id: 'fecha_retencion', label: 'Fecha Ret.', width: 130 },
  { id: 'fecha', label: 'Fecha', width: 130 },
  { id: 'tipo_comprobante', label: 'Tipo', width: 100 },
  { id: 'sucursal', label: 'Suc', width: 100 },
  { id: 'numero', label: 'Número', width: 100 },
  { id: 'comprobante_form', label: 'Suc Recibo', width: 100 },
  { id: 'comprobante_num', label: 'Número Recibo', width: 130 },
  { id: 'total', label: 'Total', width: 130 },
  { id: 'cuit', label: 'Cuit', width: 130 },
  { id: 'situacion_iva', label: 'Situ', width: 100 },
  { id: 'razon_social', label: 'Razón Social', width: 200 },
  { id: 'ivas', label: 'IVA', width: 130 },
  { id: 'neto', label: 'Neto', width: 130 },
  { id: 'IIBB', label: 'IIBB', width: 130 },
  { id: 'retencion', label: 'Retenciones', width: 100 },
  { id: 'sucons', label: 'Suc Constancia', width: 130 },
  { id: 'nucons', label: 'Número Constancia', width: 150 },
];

const PercepcionesAgipVs = () => {
...
export default PercepcionesAgipVs;
